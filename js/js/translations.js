...
(function initTranslations(global){
  const translations = {
    en: {
      ...
      quoteAddressesHint: "Fill in addresses or tap map below to add stops. Hit refresh to start over.",
      ...
      quoteTraceInfo: "Submitting a request doesn't charge you automatically, you will receive a payment link once you make your booking.",
      ...
      availabilityFlagWeekend: "Weekend/holiday date/time selected. Weekend/holiday surcharges apply.",
  ...
  aboutPageTitle: "Sobre Nosotros",
      ...
      quoteAddressesHint: "Rellena direcciones o toca el mapa de abajo para añadir paradas. Pulsa actualizar para empezar de nuevo.",
      ...
      quoteTraceInfo: "Enviar una solicitud no genera un cargo automáticamente, recibirás un enlace de pago cuando confirmes tu reserva.",
      ...
      quotePaymentReady: "Sesion de pago lista. Completa el pago para confirmar la reserva.",
      quotePaymentUnavailable: "No se pudo iniciar el pago. Intentalo de nuevo.",
      quotePaymentStartError: "No se pudo empezar el pago. Intentalo de nuevo.",
      quotePaymentInlineIntro: "Completa el pago aqui abajo para confirmar tu reserva.",
  ...
  aboutP2: "Som missatgers, recolzats per experiència real en logística urbana. Assumim responsabilitat amb les persones, la ciutat i el medi ambient.",
      ...
      quoteAddressesHint: "Omple les adreces o toca el mapa de sota per afegir parades. Prem actualitzar per començar de nou.",
      ...
      quoteTraceInfo: "Enviar una sol·licitud no et cobra automàticament, rebràs un enllaç de pagament quan confirmis la teva reserva.",
      ...
      quotePaymentReady: "Sessio de pagament llesta. Completa el pagament per confirmar la reserva.",
      quotePaymentUnavailable: "No s'ha pogut iniciar el pagament. Torna-ho a provar.",
      quotePaymentStartError: "No s'ha pogut comencar el pagament. Torna-ho a provar.",
      quotePaymentInlineIntro: "Completa el pagament aqui sota per confirmar la teva reserva.",
  ...
  aboutP2: "Somos mensageiros com experiência real em logística urbana. Assumimos responsabilidade com pessoas, cidade e meio ambiente.",
      ...
      quoteAddressesHint: "Preencha os endereços ou toque no mapa abaixo para adicionar paradas. Clique em atualizar para recomeçar.",
      ...
      quoteTraceInfo: "Enviar uma solicitação não gera cobrança automática, você receberá um link de pagamento quando confirmar a sua reserva.",
      quoteSubmit: "Solicitar reserva",
      ...
      quotePaymentReady: "Sessao de pagamento pronta. Conclua o pagamento para confirmar a reserva.",
      quotePaymentUnavailable: "Nao foi possivel iniciar o pagamento. Tente novamente.",
      quotePaymentStartError: "Nao foi possivel iniciar o pagamento. Tente novamente.",
      quotePaymentInlineIntro: "Conclua o pagamento abaixo para confirmar sua reserva.",
      quotePaymentFrameTitle: "Pagamento seguro",
      quotePaymentFallback: "Se o formulario de cartao nao aparecer, abra o pagamento em uma nova aba:",
      ...
      availabilityFlagAfterHours: "Data/hora fora do horario selecionada. Aplica-se o adicional fora do horario.",
