...
(function initTranslations(global){
  const translations = {
    en: {
      ...
      quoteCargoLarge: "Large or multiple regular +20%",
      ...
      availabilityFlagAfterHours: "After hours time slot selected - Message us to discuss this order.",
      availabilityFlagWeekend: "Weekend time slot selected - Message us to discuss this order.",
  ...
  aboutPageTitle: "Sobre Nosotros",
      ...
      quoteCargoLarge: "Grande o varios regulares +20%",
      ...
      availabilityFlagAfterHours: "Horario fuera de servicio seleccionado - Escríbenos para hablar de este pedido.",
      availabilityFlagWeekend: "Horario de fin de semana seleccionado - Escríbenos para hablar de este pedido.",
  ...
  aboutP2: "Som missatgers, recolzats per experiència real en logística urbana. Assumim responsabilitat amb les persones, la ciutat i el medi ambient.",
      ...
      quoteCargoLarge: "Gran o diversos regulars +20%",
      ...
      availabilityFlagAfterHours: "Horari fora de servei seleccionat - Escriu-nos per parlar d'aquesta comanda.",
      availabilityFlagWeekend: "Horari de cap de setmana seleccionat - Escriu-nos per parlar d'aquesta comanda.",
  ...
  aboutP2: "Somos mensageiros com experiência real em logística urbana. Assumimos responsabilidade com pessoas, cidade e meio ambiente.",
      ...
      quoteCargoRegular: "Regular (60x40x30cm) padrão",
      quoteCargoLarge: "Grande ou vários regulares +20%",
      ...
      availabilityFlagAfterHours: "Horario fora do expediente selecionado - Fale conosco para tratar deste pedido.",
      availabilityFlagWeekend: "Horario de fim de semana selecionado - Fale conosco para tratar deste pedido.",
